 ...
 *
 *    $ssh = new \myomyintaung512\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \myomyintaung512\phpseclib\Crypt\RSA();
...
namespace myomyintaung512\phpseclib\Net;

use myomyintaung512\phpseclib\Crypt\Base;
use myomyintaung512\phpseclib\Crypt\Blowfish;
use myomyintaung512\phpseclib\Crypt\Hash;
use myomyintaung512\phpseclib\Crypt\Random;
use myomyintaung512\phpseclib\Crypt\RC4;
use myomyintaung512\phpseclib\Crypt\Rijndael;
use myomyintaung512\phpseclib\Crypt\RSA;
use myomyintaung512\phpseclib\Crypt\TripleDES;
use myomyintaung512\phpseclib\Crypt\Twofish;
use myomyintaung512\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use myomyintaung512\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \myomyintaung512\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \myomyintaung512\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \myomyintaung512\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
     */
    ...
    /**#@+
     * @access public
     * @see \myomyintaung512\phpseclib\Net\SSH2::getLog()
     */
    /**
    ...
    /**#@+
     * @access public
     * @see \myomyintaung512\phpseclib\Net\SSH2::read()
     */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \myomyintaung512\phpseclib\Net\SSH2
     * @access public
     */
     ...
     * \myomyintaung512\phpseclib\Crypt\Base.
     *
     * @param string $algorithm Name of the encryption algorithm
     * @return mixed Instance of \myomyintaung512\phpseclib\Crypt\Base or null for unknown
     * @access private
     */
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \myomyintaung512\phpseclib\Crypt\RSA object or an array
     *
     ...
     *
     * @param string $username
     * @param \myomyintaung512\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \myomyintaung512\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
     ...
     * Execute Command
     *
     * If $callback is set to false then \myomyintaung512\phpseclib\Net\SSH2::_get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    function exec($command, $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \myomyintaung512\phpseclib\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \myomyintaung512\phpseclib\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
