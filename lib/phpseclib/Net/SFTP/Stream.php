...
namespace myomyintaung512\phpseclib\Net\SFTP;

use myomyintaung512\phpseclib\Crypt\RSA;
use myomyintaung512\phpseclib\Net\SFTP;
...
class Stream
{
    ...
    function _parse_path($path)
    {
        ...
        if ($host[0] == '$') {
            ...
            // casting $pass to a string is necessary in the event that it's a \myomyintaung512\phpseclib\Crypt\RSA object
     ...
     * If newname exists, it will be overwritten.  This is a departure from what \myomyintaung512\phpseclib\Net\SFTP
     * does.
     *
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \myomyintaung512\phpseclib\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     * @access public
     */
     ...
     *
     * Ignores the STREAM_URL_STAT_QUIET flag because the entirety of \myomyintaung512\phpseclib\Net\SFTP\Stream is quiet by default
     ...
     * The other two aren't supported because of limitations in \myomyintaung512\phpseclib\Net\SFTP.
     *
     * @param int $option
     * @param int $arg1
     * @param int $arg2
