 ...
 *        exit('bad login');
 *    }
 *    $scp = new \myomyintaung512\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \myomyintaung512\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \myomyintaung512\phpseclib\Net\SCP::_send()
     * @see \myomyintaung512\phpseclib\Net\SCP::_receive()
     */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \myomyintaung512\phpseclib\Net\SSH1|\myomyintaung512\phpseclib\Net\SSH2 $ssh
     * @return \myomyintaung512\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \myomyintaung512\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \myomyintaung512\phpseclib\Net\SCP::get(), you will get a file, twelve bytes
