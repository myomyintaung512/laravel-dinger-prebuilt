...
/**
 * Base Class for all \myomyintaung512\phpseclib\Crypt\* cipher classes
 *
 * PHP version 5
 *
 ...
 *
 *  - The new \myomyintaung512\phpseclib\Crypt\* cipher class should extend \myomyintaung512\phpseclib\Crypt\Base
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend \myomyintaung512\phpseclib\Crypt\Base
...
abstract class Base
{
     ...
     *
     * @see \myomyintaung512\phpseclib\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
     ...
     *
     * @see \myomyintaung512\phpseclib\Crypt\Twofish::setKey()
     * @see \myomyintaung512\phpseclib\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = true;
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \myomyintaung512\phpseclib\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \myomyintaung512\phpseclib\Crypt\*() object changes after each
     ...
     *
     * - \myomyintaung512\phpseclib\Crypt\Base::ENGINE_OPENSSL  [very fast]
     *
     * - \myomyintaung512\phpseclib\Crypt\Base::ENGINE_MCRYPT   [fast]
     *
     * - \myomyintaung512\phpseclib\Crypt\Base::ENGINE_INTERNAL [slow]
     *
     ...
     * Encrypts a block
     *
     * Note: Must be extended by the child \myomyintaung512\phpseclib\Crypt\* class
     *
     * @access private
     * @param string $in
     * @return string
     ...
     *
     * Note: Must extend by the child \myomyintaung512\phpseclib\Crypt\* class
     *
     * @see self::_setup()
     * @access private
     */
     ...
     *       - In case of using inline crypting, _setupInlineCrypt() must extend by the child \myomyintaung512\phpseclib\Crypt\* class.
    ...
    {
        // If, for any reason, an extending \myomyintaung512\phpseclib\Crypt\Base() \myomyintaung512\phpseclib\Crypt\* class
        // not using inline crypting then it must be ensured that: $this->use_inline_crypt = false
        // ie in the class var declaration of $use_inline_crypt in general for the \myomyintaung512\phpseclib\Crypt\* class,
     ...
     *    </code>
     *
     *    See also the \myomyintaung512\phpseclib\Crypt\*::_setupInlineCrypt()'s for
