 ...
 *
 *    $des = new \myomyintaung512\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
     ...
     * @see \myomyintaung512\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \myomyintaung512\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
