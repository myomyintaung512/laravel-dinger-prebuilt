 ...
 *
 *    $rsa = new \myomyintaung512\phpseclib\Crypt\RSA();
...
class RSA
{
    ...
    /**#@+
     * @access private
     * @see \myomyintaung512\phpseclib\Crypt\RSA::createKey()
     */
    /**
     * ASN1 Integer
     */
    ...
    /**#@+
     * @access private
     * @see \myomyintaung512\phpseclib\Crypt\RSA::__construct()
     */
    /**
     ...
     * @access public
     * @see \myomyintaung512\phpseclib\Crypt\RSA::createKey()
     * @see \myomyintaung512\phpseclib\Crypt\RSA::setPrivateKeyFormat()
     */
    /**
     ...
     * @access public
     * @see \myomyintaung512\phpseclib\Crypt\RSA::createKey()
     * @see \myomyintaung512\phpseclib\Crypt\RSA::setPublicKeyFormat()
     */
    /**
     * Raw public key
     *
     * An array containing two \myomyintaung512\phpseclib\Math\BigInteger objects.
     *
     ...
     * Precomputed Zero
     *
     * @var \myomyintaung512\phpseclib\Math\BigInteger
     * @access private
     */
    var $zero;
     ...
     * Hash function
     *
     * @var \myomyintaung512\phpseclib\Crypt\Hash
     * @access private
     */
    var $hash;
     ...
     * \myomyintaung512\phpseclib\Crypt\RSA doesn't do it is because OpenSSL doesn't fail gracefully.  openssl_pkey_new(), in particular, requires
     * openssl.cnf be present somewhere and, unfortunately, the only real way to find out is too late.
     *
     * @return \myomyintaung512\phpseclib\Crypt\RSA
     * @access public
     */
     ...
     *                  Will need to be passed back to \myomyintaung512\phpseclib\Crypt\RSA::createKey() as the third parameter for further processing.
     *
     * @access public
     * @param int $bits
     * @param int $timeout
    ...
    {
        // \myomyintaung512\phpseclib\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
        switch ($hash) {
            case 'md2':
            case 'md5':
            case 'sha1':
     ...
     * @access private
     * @param \myomyintaung512\phpseclib\Math\BigInteger $x
     * @param \myomyintaung512\phpseclib\Math\BigInteger $r
     * @param int $i
     * @return \myomyintaung512\phpseclib\Math\BigInteger
     */
     ...
     *
     * @access private
     * @param \myomyintaung512\phpseclib\Math\BigInteger $m
     * @return \myomyintaung512\phpseclib\Math\BigInteger
     */
    function _rsaep($m)
    {
     ...
     *
     * @access private
     * @param \myomyintaung512\phpseclib\Math\BigInteger $c
     * @return \myomyintaung512\phpseclib\Math\BigInteger
     */
    function _rsadp($c)
    {
     ...
     *
     * @access private
     * @param \myomyintaung512\phpseclib\Math\BigInteger $s
     * @return \myomyintaung512\phpseclib\Math\BigInteger
     */
    function _rsavp1($s)
    {
     ...
     *
     * As a consequence of this, a private key encrypted ciphertext produced with \myomyintaung512\phpseclib\Crypt\RSA may not decrypt
